...
@Entity
@Table(name = "TESTE_RAPIDO_COVID")
public class TesteRapidoCovid implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "cd_teste_rapido")
	...
	@Column(name = "sn_igg_positivo", nullable = true, length = 1)
	private String igg;
	...
	public TesteRapidoCovid() {
		
	}
	
	public TesteRapidoCovid(Integer id) {
		this.id = id;
	}
	
	public TesteRapidoCovid(Integer id, String nome) {
		this.id = id;
	...
	public TesteRapidoCovid(Integer id, String ativo, String nome) {
		super();
		this.id = id;
		this.ativo = ativo;
		Pessoa pessoa = new Pessoa();
