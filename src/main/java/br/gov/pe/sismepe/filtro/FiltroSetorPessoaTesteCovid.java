...
public class FiltroSetorPessoaTesteCovid extends FiltroGenerico<SetorPessoaTesteCovid> implements Serializable {
	...
	public String getFromQuery() {
		StringBuilder fromQuery = new StringBuilder();
		String tabela = SetorPessoaTesteCovid.class.getAnnotation(javax.persistence.Table.class).name();
	...
	@Override
	public List<SetorPessoaTesteCovid> montarObjeto(List<Object[]> retorno) {
		List<SetorPessoaTesteCovid> lista = new ArrayList<SetorPessoaTesteCovid>();
		for (Object[] obj : retorno) {
			Integer id = ((Integer) obj[0]);
			String descricao = (String) obj[1];
			String ativo = (String) obj[2];
			
			SetorPessoaTesteCovid entidade = new SetorPessoaTesteCovid();
			entidade.setId(id);
